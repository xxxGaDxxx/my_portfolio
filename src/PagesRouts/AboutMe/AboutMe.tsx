      ...
      <div className={styles.container}>
        <div className={style.img_personal_info}>
          ...
          <div className={style.person_info}>
            ...
            <p className={style.description_person}>Front-end React/Redux developer with experience
              creating
              SPAs
              using React, Redux, TypeScript/JavaScript, RestAPI, HTML, CSS. I like to develop
              applications
              that
              bring real benefit to the end user. Right now improving my skills in this direction.
              Ready
              for
              your
              suggestions.</p>
