      ...
      <div className={style.container_project}>
        ...
        <div className={style.bloc_description}>
          ...
          <ul className={style.list}>
            ...
            <li><span><SvgIcon
              icon={'technologies'}/>Used Technologies:</span>{props.project.technologies}
            </li>
          </ul>
          <hr/>
          <a href={`${props.project.href_Project}`} target="_blank" className={style.preview}>preview<SvgIcon
            icon={'preview'}/></a>
        </div>
      </div>
    </div>
